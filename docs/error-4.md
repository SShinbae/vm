...
app/logs/fuel/[id]/edit.tsx:67:72 - error TS2345: Argument of type '{ includeVehicle: boolean; }' is not assignable to parameter of type 'string'.

67 const { data: logs, error } = await FuelLogService.getFuelLogs({
~
68 includeVehicle: true,

```
69         });
~~~~~~~~~

app/logs/fuel/[id]/edit.tsx:101:27 - error TS2339: Property 'fuel_price' does not exist on type '{ id: string; vehicle_id: string; user_id: string; liters_filled: number; cost: number | null; date: string; odometer_reading: number; location: string | null; created_at: string; }'.

101           fuel_price: log.fuel_price || 1.99, // Default if not set
                           ~~~~~~~~~~
...
components/VehicleDetail.tsx:496:17 - error TS2769: No overload matches this call.
Overload 1 of 2, '(props: ViewProps): View', gave the following error.
 Type '{ children: Element[]; style: (false | { shadowColor?: string | undefined; shadowOffset?: { width: number; height: number; } | undefined; shadowOpacity?: number | undefined; shadowRadius?: number | undefined; ... 10 more ...; borderColor: string; } | { ...; })[]; onMouseEnter: (() => void) | undefined; onMouseLeave:...' is not assignable to type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
   Property 'onMouseEnter' does not exist on type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
Overload 2 of 2, '(props: ViewProps, context: any): View', gave the following error.
 Type '{ children: Element[]; style: (false | { shadowColor?: string | undefined; shadowOffset?: { width: number; height: number; } | undefined; shadowOpacity?: number | undefined; shadowRadius?: number | undefined; ... 10 more ...; borderColor: string; } | { ...; })[]; onMouseEnter: (() => void) | undefined; onMouseLeave:...' is not assignable to type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
   Property 'onMouseEnter' does not exist on type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.

496                 onMouseEnter={isWeb ? () => setHoveredItem("mileage") : undefined}
                 ~~~~~~~~~~~~


components/VehicleDetail.tsx:527:17 - error TS2769: No overload matches this call.
Overload 1 of 2, '(props: ViewProps): View', gave the following error.
 Type '{ children: Element[]; style: (false | { shadowColor?: string | undefined; shadowOffset?: { width: number; height: number; } | undefined; shadowOpacity?: number | undefined; shadowRadius?: number | undefined; ... 10 more ...; borderColor: string; } | { ...; })[]; onMouseEnter: (() => void) | undefined; onMouseLeave:...' is not assignable to type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
   Property 'onMouseEnter' does not exist on type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
Overload 2 of 2, '(props: ViewProps, context: any): View', gave the following error.
...
527                 onMouseEnter={isWeb ? () => setHoveredItem("fuel") : undefined}
                 ~~~~~~~~~~~~


components/VehicleDetail.tsx:568:17 - error TS2769: No overload matches this call.
Overload 1 of 2, '(props: ViewProps): View', gave the following error.
 Type '{ children: Element[]; style: (false | { shadowColor?: string | undefined; shadowOffset?: { width: number; height: number; } | undefined; shadowOpacity?: number | undefined; shadowRadius?: number | undefined; ... 10 more ...; borderColor: string; } | { ...; })[]; onMouseEnter: (() => void) | undefined; onMouseLeave:...' is not assignable to type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
   Property 'onMouseEnter' does not exist on type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
Overload 2 of 2, '(props: ViewProps, context: any): View', gave the following error.
...
568                 onMouseEnter={isWeb ? () => setHoveredItem("service") : undefined}
                 ~~~~~~~~~~~~


components/VehicleDetail.tsx:609:17 - error TS2769: No overload matches this call.
Overload 1 of 2, '(props: ViewProps): View', gave the following error.
 Type '{ children: Element[]; style: (false | { shadowColor?: string | undefined; shadowOffset?: { width: number; height: number; } | undefined; shadowOpacity?: number | undefined; shadowRadius?: number | undefined; ... 10 more ...; borderColor: string; } | { ...; })[]; onMouseEnter: (() => void) | undefined; onMouseLeave:...' is not assignable to type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
   Property 'onMouseEnter' does not exist on type 'IntrinsicAttributes & IntrinsicClassAttributes<View> & Readonly<ViewProps>'.
Overload 2 of 2, '(props: ViewProps, context: any): View', gave the following error.
...
609                 onMouseEnter={isWeb ? () => setHoveredItem("mileage-records") : undefined}
                 ~~~~~~~~~~~~
...
lib/services/vehicleService.ts:53:9 - error TS2558: Expected 2 type arguments, but got 1.

53         VehicleSharingInfo[]
       ~~~~~~~~~~~~~~~~~~~~

lib/services/vehicleService.ts:61:64 - error TS2339: Property 'length' does not exist on type 'never'.

61       console.log("✅ Raw vehicle data received:", vehicleData?.length || 0);
                                                              ~~~~~~

lib/services/vehicleService.ts:65:29 - error TS2339: Property 'map' does not exist on type 'never[FnName]["Returns"]'.

65         (vehicleData || []).map(async (vehicle: VehicleSharingInfo) => {
                           ~~~

lib/services/vehicleService.ts:81:44 - error TS2349: This expression is not callable.
Type 'PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, never[], "vehicle_group_shares", never, "GET">' has no call signatures.

81             const { data: shares } = await supabase
                                           ~~~~~~~~
82               .from("vehicle_group_shares")
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
88               `,
~~~~~~~~~~~~~~~~
...
lib/services/vehicleService.ts:92:41 - error TS7006: Parameter 'share' implicitly has an 'any' type.

92             sharedGroups = shares?.map((share) => share.groups) || [];
                                       ~~~~~

lib/services/vehicleService.ts:241:9 - error TS2345: Argument of type '{ vehicle_uuid: string; group_uuids: string[]; }' is not assignable to parameter of type 'undefined'.

241         { vehicle_uuid: vehicleId, group_uuids: groupIds },
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

lib/services/vehicleService.ts:288:19 - error TS2339: Property 'user_id' does not exist on type 'never'.

288       if (vehicle.user_id !== user.id) {
                  ~~~~~~~

lib/services/vehicleService.ts:297:58 - error TS2349: This expression is not callable.
Type 'PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, never[], "vehicle_group_shares", never, "GET">' has no call signatures.

297       const { data: shares, error: sharesError } = await supabase
                                                         ~~~~~~~~
298         .from("vehicle_group_shares")
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
304         `,
~~~~~~~~~~
305         )<{ group_id: string; shared_at: string; groups: Group }[]>()
~~~~~~~~~

lib/services/vehicleService.ts:315:35 - error TS7006: Parameter 'share' implicitly has an 'any' type.

315         (shares || []).map(async (share) => {
                                  ~~~~~

lib/services/vehicleService.ts:422:10 - error TS2769: No overload matches this call.
...
lib/services/vehicleService.ts:438:19 - error TS2339: Property 'id' does not exist on type 'never'.

438           vehicle.id,
                  ~~

lib/services/vehicleService.ts:447:62 - error TS2339: Property 'id' does not exist on type 'never'.

447       console.log("✅ Vehicle created successfully:", vehicle.id);
                                                             ~~

lib/services/vehicleService.ts:494:17 - error TS2345: Argument of type '{ updated_at: string; make?: string; model?: string; year?: number; license_plate?: string; vin?: string | null; main_image_url?: string | null; color?: string | null; current_mileage?: number; }' is not assignable to parameter of type 'never'.
...
lib/services/vehicleService.ts:552:19 - error TS2339: Property 'user_id' does not exist on type 'never'.

552       if (vehicle.user_id !== user.id) {
                  ~~~~~~~

lib/services/vehicleService.ts:616:17 - error TS2339: Property 'user_id' does not exist on type 'never'.

616         vehicle.user_id === user.id ||
                ~~~~~~~

lib/services/vehicleService.ts:635:9 - error TS2349: This expression is not callable.
Type 'PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, never[], "vehicle_images", never, "GET">' has no call signatures.

635         supabase
        ~~~~~~~~
636           .from("vehicle_images")
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
639           .order("image_type", { ascending: true })
```

640 .order("display_order", { ascending: true })<VehicleImage[]>(),

````

lib/services/vehicleService.ts:641:17 - error TS2339: Property 'user_id' does not exist on type 'never'.

641         vehicle.user_id === user.id
                ~~~~~~~

lib/services/vehicleService.ts:644:17 - error TS2339: Property 'user_id' does not exist on type 'never'.

644         vehicle.user_id !== user.id
                ~~~~~~~

lib/services/vehicleService.ts:648:33 - error TS2339: Property 'user_id' does not exist on type 'never'.

648               .eq("id", vehicle.user_id)
                                ~~~~~~~

lib/services/vehicleService.ts:656:9 - error TS2698: Spread types may only be created from object types.

656         ...vehicle,
        ~~~~~~~~~~

lib/services/vehicleService.ts:657:33 - error TS2339: Property 'user_id' does not exist on type 'never'.

657         is_own_vehicle: vehicle.user_id === user.id,
                                ~~~~~~~

lib/services/vehicleService.ts:661:50 - error TS7006: Parameter 'sg' implicitly has an 'any' type.

661           sharingResult.data?.shared_groups.map((sg) => ({
                                                 ~~

lib/services/vehicleService.ts:673:18 - error TS7006: Parameter 'sg' implicitly has an 'any' type.

673                 (sg) => sg.group_name,
                 ~~

lib/services/vehicleService.ts:688:21 - error TS2339: Property 'mileage_logs' does not exist on type 'never'.

688             vehicle.mileage_logs?.[0] ||
                    ~~~~~~~~~~~~

lib/services/vehicleService.ts:692:21 - error TS2339: Property 'fuel_logs' does not exist on type 'never'.

692             vehicle.fuel_logs?.[0] ||
                    ~~~~~~~~~

lib/services/vehicleService.ts:731:58 - error TS2339: Property 'group_id' does not exist on type 'never'.

731       const sharedGroupIds = shares.map((share) => share.group_id);
                                                         ~~~~~~~~

lib/services/vehicleService.ts:780:45 - error TS2339: Property 'odometer_reading' does not exist on type 'never'.

780         currentMileage: latestMileage?.[0]?.odometer_reading || 0,
                                            ~~~~~~~~~~~~~~~~

lib/services/vehicleService.ts:815:45 - error TS2339: Property 'odometer_reading' does not exist on type 'never'.

815         const newMileage = latestMileage[0].odometer_reading;
                                            ~~~~~~~~~~~~~~~~

lib/services/vehicleService.ts:820:19 - error TS2345: Argument of type '{ current_mileage: any; }' is not assignable to parameter of type 'never'.

820           .update({ current_mileage: newMileage })
                  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

lib/services/vehicleService.ts:873:17 - error TS2344: Type '{ groups: { id: string; name: string; description: string | null; owner_id: string; created_at: string; updated_at: string; }; }' does not satisfy the constraint 'string'.

873         .select<{ groups: Group }>(
                ~~~~~~~~~~~~~~~~~

lib/services/vehicleService.ts:894:29 - error TS2339: Property 'groups' does not exist on type 'never'.

894         .map((item) => item.groups)
                            ~~~~~~

lib/services/vehicleService.ts:901:38 - error TS2339: Property 'id' does not exist on type 'never'.

901         if (!allGroups.find((g) => g.id === group.id)) {
                                     ~~

lib/services/vehicleService.ts:902:26 - error TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.

902           allGroups.push(group);
                         ~~~~~

lib/services/vehicleService.ts:1172:10 - error TS7006: Parameter 'template' implicitly has an 'any' type.

1172         (template) => ({
          ~~~~~~~~

lib/services/vehicleService.ts:1177:20 - error TS7006: Parameter 'a' implicitly has an 'any' type.

1177             .sort((a, b) => a.display_order - b.display_order)
                    ~

lib/services/vehicleService.ts:1177:23 - error TS7006: Parameter 'b' implicitly has an 'any' type.

1177             .sort((a, b) => a.display_order - b.display_order)
                       ~

lib/services/vehicleService.ts:1178:19 - error TS7006: Parameter 'item' implicitly has an 'any' type.

1178             .map((item) => ({
                   ~~~~

lib/services/vehicleService.ts:1259:22 - error TS2339: Property 'id' does not exist on type 'never'.

1259         id: template.id,
                      ~~

lib/services/vehicleService.ts:1260:24 - error TS2339: Property 'name' does not exist on type 'never'.

1260         name: template.name,
                        ~~~~

lib/services/vehicleService.ts:1261:31 - error TS2339: Property 'description' does not exist on type 'never'.

1261         description: template.description || "",
                               ~~~~~~~~~~~

lib/services/vehicleService.ts:1262:26 - error TS2339: Property 'service_template_items' does not exist on type 'never'.

1262         items: (template.service_template_items || [])
                          ~~~~~~~~~~~~~~~~~~~~~~

lib/services/vehicleService.ts:1263:18 - error TS7006: Parameter 'a' implicitly has an 'any' type.

1263           .sort((a, b) => a.display_order - b.display_order)
                  ~

lib/services/vehicleService.ts:1263:21 - error TS7006: Parameter 'b' implicitly has an 'any' type.

1263           .sort((a, b) => a.display_order - b.display_order)
                     ~

lib/services/vehicleService.ts:1264:17 - error TS7006: Parameter 'item' implicitly has an 'any' type.

1264           .map((item) => ({
                 ~~~~

lib/services/vehicleService.ts:1270:41 - error TS2339: Property 'total_cost' does not exist on type 'never'.

1270         total_cost: parseFloat(template.total_cost),
                                         ~~~~~~~~~~

lib/services/vehicleService.ts:1271:30 - error TS2339: Property 'created_at' does not exist on type 'never'.

1271         created_at: template.created_at,
                              ~~~~~~~~~~

lib/services/vehicleService.ts:1272:30 - error TS2339: Property 'updated_at' does not exist on type 'never'.

1272         updated_at: template.updated_at,
                              ~~~~~~~~~~

lib/services/vehicleService.ts:1320:10 - error TS2769: No overload matches this call.
Overload 1 of 2, '(values: never, options?: { count?: "exact" | "planned" | "estimated" | undefined; } | undefined): PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, null, "service_templates", never, "POST">', gave the following error.
Argument of type '{ user_id: string; name: string; description: string; total_cost: number; }' is not assignable to parameter of type 'never'.
Overload 2 of 2, '(values: never[], options?: { count?: "exact" | "planned" | "estimated" | undefined; defaultToNull?: boolean | undefined; } | undefined): PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, null, "service_templates", never, "POST">', gave the following error.
Object literal may only specify known properties, and 'user_id' does not exist in type 'never[]'.
...
lib/services/vehicleService.ts:1337:33 - error TS2339: Property 'id' does not exist on type 'never'.

1337           template_id: template.id,
                                 ~~

lib/services/vehicleService.ts:1345:19 - error TS2769: No overload matches this call.
Overload 1 of 2, '(values: never, options?: { count?: "exact" | "planned" | "estimated" | undefined; } | undefined): PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, null, "service_template_items", never, "POST">', gave the following error.
Argument of type '{ template_id: any; description: string; price: number; display_order: number; }[]' is not assignable to parameter of type 'never'.
Overload 2 of 2, '(values: never[], options?: { count?: "exact" | "planned" | "estimated" | undefined; defaultToNull?: boolean | undefined; } | undefined): PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, null, "service_template_items", never, "POST">', gave the following error.
Argument of type '{ template_id: any; description: string; price: number; display_order: number; }[]' is not assignable to parameter of type 'never[]'.
  Type '{ template_id: any; description: string; price: number; display_order: number; }' is not assignable to type 'never'.

1345           .insert(templateItems);
                   ~~~~~~~~~~~~~


lib/services/vehicleService.ts:1352:32 - error TS2339: Property 'id' does not exist on type 'never'.

1352             .eq("id", template.id);
                                ~~

lib/services/vehicleService.ts:1362:70 - error TS2339: Property 'id' does not exist on type 'never'.

1362       const createdTemplate = await this.getServiceTemplate(template.id);
                                                                      ~~

lib/services/vehicleService.ts:1372:72 - error TS2339: Property 'id' does not exist on type 'never'.

1372       console.log("✅ Service template created successfully:", template.id);
                                                                        ~~

lib/services/vehicleService.ts:1426:17 - error TS2345: Argument of type '{ name: string; description: string; }' is not assignable to parameter of type 'never'.

1426         .update({
                 ~
1427           name: formData.name,
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
1428           description: formData.description || "",
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
1429         })
 ~~~~~~~~~

lib/services/vehicleService.ts:1462:19 - error TS2769: No overload matches this call.
Overload 1 of 2, '(values: never, options?: { count?: "exact" | "planned" | "estimated" | undefined; } | undefined): PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, null, "service_template_items", never, "POST">', gave the following error.
Argument of type '{ template_id: string; description: string; price: number; display_order: number; }[]' is not assignable to parameter of type 'never'.
Overload 2 of 2, '(values: never[], options?: { count?: "exact" | "planned" | "estimated" | undefined; defaultToNull?: boolean | undefined; } | undefined): PostgrestFilterBuilder<{ PostgrestVersion: "12"; }, never, never, null, "service_template_items", never, "POST">', gave the following error.
Argument of type '{ template_id: string; description: string; price: number; display_order: number; }[]' is not assignable to parameter of type 'never[]'.
  Type '{ template_id: string; description: string; price: number; display_order: number; }' is not assignable to type 'never'.

1462           .insert(templateItems);
                   ~~~~~~~~~~~~~
...
Errors  Files
 ...
 2  app/logs/fuel/[id]/edit.tsx:67
...
13  components/ui/NotificationList.tsx:81
 ...
 4  components/VehicleDetail.tsx:496
...
55  lib/services/vehicleService.ts:53
