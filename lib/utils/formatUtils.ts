 ...
 */
export function safeToFixed(value: number | null | undefined, decimals: number = 2, fallback: number = 0): string {
 ...
 */
export function safeFormatCurrency(value: number | null | undefined, decimals: number = 2, fallback: number = 0): string {
...
export function safeGetExpenseAmount(
  expenseBreakdown: Array<{category: string; amount: number}> | null | undefined,
  category: string,
  decimals: number = 2
): string {
