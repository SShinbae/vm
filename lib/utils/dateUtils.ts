...
/**
 * Formats a date for display in a relative format (e.g., "Added 12-03-2024")
 * @param date - Date object, ISO string, or timestamp
 * @param prefix - Optional prefix text (e.g., "Added", "Created", "Updated")
 * @returns Formatted string with prefix and DD-MM-YYYY date
 */
...
/**
 * Converts DD-MM-YYYY or DD/MM/YYYY string to ISO date string for database storage
