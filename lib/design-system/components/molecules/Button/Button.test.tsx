...
describe("Button Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render with custom text", () => {
      ...
      const { getByText } = render(
        <Button onPress={onPress}>Custom Text</Button>,
      );
  ...
  describe("Sizes", () => {
    ...
    it("should render medium size (default)", () => {
      const onPress = jest.fn();
      const { getByText } = render(
        <Button size="md" onPress={onPress}>
          Medium
        </Button>,
      );
  ...
  describe("States", () => {
    ...
    it("should render fullWidth correctly", () => {
      const onPress = jest.fn();
      const { getByText } = render(
        <Button onPress={onPress} fullWidth>
          Full Width
        </Button>,
      );
  ...
  describe("Icons", () => {
    it("should render with left icon", () => {
      const onPress = jest.fn();
      const { getByText } = render(
        <Button onPress={onPress} leftIcon="add">
          With Icon
        </Button>,
      );
    ...
    it("should render with right icon", () => {
      const onPress = jest.fn();
      const { getByText } = render(
        <Button onPress={onPress} rightIcon="forward">
          With Icon
        </Button>,
      );
  ...
  describe("Accessibility", () => {
    it("should have correct accessibility role", () => {
      ...
      const { getByRole } = render(
        <Button onPress={onPress}>Accessible</Button>,
      );
  ...
  describe("Styles", () => {
    it("should accept custom style prop", () => {
      ...
      const { getByText } = render(
        <Button onPress={onPress} style={customStyle}>
          Styled
        </Button>,
      );
