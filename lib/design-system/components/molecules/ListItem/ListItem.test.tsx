...
describe('ListItem Component', () => {
  ...
  describe('Divider', () => {
    it('should render with divider when showDivider is true', () => {
      const { getByText } = render(
        <ListItem title="Title" showDivider />
      );
  ...
  describe('Interactions', () => {
    ...
    it('should not be pressable without onPress', () => {
      const { getByText } = render(
        <ListItem title="Non-Pressable Item" />
      );
  ...
  describe('Multi-line Support', () => {
    ...
    it('should handle long subtitle text', () => {
      const longSubtitle = 'This is a very long subtitle that should wrap to multiple lines';
      const { getByText } = render(
    ...
    it('should handle long description text', () => {
      const longDescription = 'This is a very long description that should wrap to multiple lines and display correctly';
      const { getByText } = render(
