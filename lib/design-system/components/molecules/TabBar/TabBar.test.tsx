...
describe('TabBar Component', () => {
  ...
  describe('Interactions', () => {
    ...
    it('should not call onTabChange for disabled tab', () => {
      ...
      const onTabChange = jest.fn();
      const { getByText } = render(
        <TabBar tabs={disabledTabs} activeTab="tab1" onTabChange={onTabChange} />
      );
  ...
  describe('Icons', () => {
    it('should render tabs with icons', () => {
      ...
      const onTabChange = jest.fn();
      const { getByText } = render(
        <TabBar tabs={tabsWithIcons} activeTab="home" onTabChange={onTabChange} />
      );
  ...
  describe('Badges', () => {
    it('should render tabs with badges', () => {
      ...
      const onTabChange = jest.fn();
      const { getByText } = render(
        <TabBar tabs={tabsWithBadges} activeTab="tab1" onTabChange={onTabChange} />
      );
  ...
  describe('Disabled State', () => {
    it('should render disabled tabs', () => {
      ...
      const onTabChange = jest.fn();
      const { getByText } = render(
        <TabBar tabs={tabsWithDisabled} activeTab="tab1" onTabChange={onTabChange} />
      );
  ...
  describe('Combined Features', () => {
    it('should render tabs with icons, badges, and scrollable', () => {
      const complexTabs = [
        ...
        { key: 'search', label: 'Search', icon: 'search' as const },
        { key: 'notifications', label: 'Notifications', icon: 'notification' as const, badge: 10 },
      ];
      const onTabChange = jest.fn();
      const { getByText } = render(
        <TabBar 
