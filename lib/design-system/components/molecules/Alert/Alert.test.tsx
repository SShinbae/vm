...
describe("Alert Component", () => {
  ...
  describe("Action Button", () => {
    ...
    it("should not render action button without action", () => {
      const { getByText } = render(<Alert message="Alert without action" />);
  ...
  describe("Icons", () => {
    ...
    it("should render error icon for error severity", () => {
      const { getByText } = render(<Alert severity="error" message="Error" />);

      expect(getByText("Error")).toBeTruthy();
    });

    it("should render info icon for info severity", () => {
      const { getByText } = render(<Alert severity="info" message="Info" />);
