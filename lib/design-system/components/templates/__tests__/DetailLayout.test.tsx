...
describe('DetailLayout', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render related items', () => {
      render(
        <DetailLayout {...defaultProps} relatedItems={<Text>Related Items</Text>} />
      );
    ...
    it('should render actions', () => {
      render(
        <DetailLayout {...defaultProps} actions={<Text>Action Buttons</Text>} />
      );
  ...
  describe('Tabs', () => {
    ...
    it('should call onTabChange when tab is pressed', () => {
      ...
      render(<DetailLayout {...defaultProps} tabs={tabs} onTabChange={onTabChange} />);
      const tab2 = screen.getByText('Tab 2');
      fireEvent.press(tab2);
