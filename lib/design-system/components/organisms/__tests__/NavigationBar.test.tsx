...
describe('NavigationBar', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render all tabs', () => {
      render(<NavigationBar tabs={mockTabs} activeTab="home" onTabChange={jest.fn()} />);
    ...
    it('should render tabs without icons', () => {
      ...
      render(<NavigationBar tabs={tabsWithoutIcons} activeTab="home" onTabChange={jest.fn()} />);
      expect(screen.getByText('Home')).toBeTruthy();
      expect(screen.getByText('Search')).toBeTruthy();
    });
  });
  ...
  describe('Active Tab', () => {
    it('should highlight active tab', () => {
      render(<NavigationBar tabs={mockTabs} activeTab="search" onTabChange={jest.fn()} />);
      expect(screen.getByText('Search')).toBeTruthy();
    });

    it('should call onTabChange when tab is pressed', () => {
      const onTabChange = jest.fn();
      render(<NavigationBar tabs={mockTabs} activeTab="home" onTabChange={onTabChange} />);
  ...
  describe('Badge Display', () => {
    it('should render badge when badge count is greater than 0', () => {
      ...
      render(<NavigationBar tabs={tabsWithBadge} activeTab="home" onTabChange={jest.fn()} />);
  ...
  describe('Disabled Tabs', () => {
    it('should not call onTabChange for disabled tab', () => {
      ...
      const tabsWithDisabled: NavigationTab[] = [
        { id: 'home', label: 'Home', icon: 'house' },
        { id: 'search', label: 'Search', icon: 'magnifyingglass', disabled: true },
      ];
      render(<NavigationBar tabs={tabsWithDisabled} activeTab="home" onTabChange={onTabChange} />);
      const searchTab = screen.getByLabelText('Search');
      fireEvent.press(searchTab);
      expect(onTabChange).not.toHaveBeenCalled();
    });
    ...
    it('should apply disabled styles to disabled tab', () => {
      ...
      render(<NavigationBar tabs={tabsWithDisabled} activeTab="home" onTabChange={jest.fn()} />);
      const searchTab = screen.getByLabelText('Search');
  ...
  describe('Variant Styles', () => {
    ...
    it('should apply filled variant styles', () => {
      render(
        <NavigationBar tabs={mockTabs} activeTab="home" onTabChange={jest.fn()} variant="filled" />
      );
      expect(screen.getByText('Home')).toBeTruthy();
    });
  });
  ...
  describe('Position', () => {
    ...
    it('should apply top position when specified', () => {
      render(
        <NavigationBar tabs={mockTabs} activeTab="home" onTabChange={jest.fn()} position="top" />
      );
      expect(screen.getByText('Home')).toBeTruthy();
    });
  });
  ...
  describe('Show Labels', () => {
    ...
    it('should hide labels when showLabels is false', () => {
      render(
        <NavigationBar tabs={mockTabs} activeTab="home" onTabChange={jest.fn()} showLabels={false} />
      );
